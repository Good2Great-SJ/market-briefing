...
오인식 단어가 섞여 있을 수 있습니다). **총평은 반드시 이 원천 콘텐츠의 논리와 시각을
1차 근거로 삼아 작성**하세요. 하단 [데이터 요약]은 원천 콘텐츠의 주장을 뒷받침하는
수치 근거로만 보조적으로 사용하세요.
...
{{
  "overview": "장 흐름 총평 3~5문장. 원천 콘텐츠의 핵심 시각(무엇 때문에 시장이 이렇게 움직였는지)을 반영해 서술.",
  "checkpoints": ["원천 콘텐츠가 강조한 체크포인트 3~5개, 각 한 문장"],
  "news": [{{"title":"원천 콘텐츠가 언급한 시장 영향 뉴스/이벤트","impact":"영향 한 줄"}}],
  "calendar": [{{"date":"MM/DD 또는 요일 등 원천 콘텐츠에 언급된 표현 그대로","event":"원천 콘텐츠가 언급한 다가오는 일정"}}],
